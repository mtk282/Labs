...
def plot_two_sphere_profiles(x1=900,z1=200.0,rho1=1000., srad1=200.,x2 = 900, z2=-100, rho2=2000, srad2=100.):
...
#    rho2=2000
    ...
    y1=0.0
    y2=0.0
    obs_range=np.arange(-1,2000,100)
    ...
    for ii in range(len(x)):
        ...
        ax1.plot(obs_range, gravity_profile_z, linewidth=4,color=cvec[ii], label='Sphere')
        ax1.plot(dist, grav, linewidth=4,color='green', label='VL GRAV')
        circle = plt.Circle((xsrc[0],xsrc[2]),src_radius[ii],color=cvec[ii])
        ax2.add_artist(circle)
        #ax3.plot(dist, grav, linewidth=4,color=cvec[ii])
    #ax1.plot(obs_range, gravity_profile_z, linewidth=4,color='black')
    #ax1.plot(dist, grav, linewidth=4,color=cvec[ii])
    #circle = plt.Circle((xsrc[0],xsrc[2]),src_radius[ii],color=cvec[ii])
    #ax2.add_artist(circle)
...
def plot_sphere_cylinder_profiles(x1=900.0,z1=200.,rho1=1000., srad1=200.,x2 = 900.0, z2=-100, rho2=2000, srad2=100.):
...
def plot_sphere_cylinder_slab_profiles(x1=0.0,z1=200.,rho1=1000., srad1=200.,
    ...
    ax2.fill_between(slabx,slabz,-1000)
